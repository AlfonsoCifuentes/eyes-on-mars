  ...
  if (error) {
    ...
    <div className="pageDiv">
      ...
      <div style={headerStyles} className="headerDiv">
          ...
          <div>
            <h1 className="headerDiv__title"><span style={roverStyles} className="headerDiv__title--roverName">CURIOSITY</span> Rover</h1>
            <h2 className="headerDiv__subtitle">Latest photos</h2>
          </div>

        <div style={subheaderStyles} className="headerDiv__subdiv">

          <img className="headerDiv__image" src={require ("../../Images/Curiosity.png")} alt="Curiosity Rover" />


          <div className="headerDiv__text">
         
          <p>Here you can see the Mars surface photos taken from the many cameras of the <span style={textStyles}><strong>Curiosity</strong></span> rover. Pictures are always up-to-date, the latest pictures available. Below you can select the different cameras to filter the list of photos to a certain camera.</p>
          </div>
